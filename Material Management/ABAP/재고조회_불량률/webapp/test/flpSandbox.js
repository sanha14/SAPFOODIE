		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "재고조회 프로그램",
									"targetURL": "#b02mminquirymminquiry-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"b02mminquirymminquiry-display": {
								"semanticObject": "b02mminquirymminquiry",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=b02.mm.inquiry.mminquiry",
									"url": sap.ui.require.toUrl("b02/mm/inquiry/mminquiry")
								}
							}
						}
					}
