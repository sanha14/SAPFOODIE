		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#b02mmorderapprovalmmorderapproval02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"b02mmorderapprovalmmorderapproval02-display": {
								"semanticObject": "b02mmorderapprovalmmorderapproval02",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=b02.mm.orderapproval.mmorderapproval02",
									"url": sap.ui.require.toUrl("b02/mm/orderapproval/mmorderapproval02")
								}
							}
						}
					}
